    ...
    return (
        <div className="page-content">
            <div id='whatIsClassical' className='info-block text-center'>
                ...
                <a className='text-center w-100' href='https://www.paypal.com/donate?token=oEXWya0OAl_Mc6bE1PF_SbbEoXUz8-vE2iQEX1sfAS6Gf0xVKTYIME6wuZYltrDLnqa5Z9I53tNkmHPb' target='_blank'>
