    ...
    return (
        <div className='d-flex flex-column align-items-center'>
            ...
            <div className="page-content">
                ...
                <div id='whatIsClassical' style={{ borderBottom: '2px solid black' }} className='info-block'>
                    ...
                    <img src={enroll1} className='col-12' />
                    ...
                    <img src={enroll2} className='col-12' alt='Screenshot highlighting the place new families can signup for a new Sycamore account prior to enrollment.' />
                    <p className='pt-3'>
                        <em>As a new family, click on the “I need a new account” register button.

                        </em>
                    </p>
                    <img src={enroll3} className='col-12' alt='Screenshot showing where new families can enter their information when signing of for a Sycamore account pior to applying.' />
                    <p className='pt-3'>
