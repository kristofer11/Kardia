import Karate from '../../assets/blog/thao-le-hoang-igLzPKOvZNw-unsplash-1-1024x681.jpg'

const July2022 = () => {
    return (
        <div className='page-content blog'>
            <p className='blog-author'>JULY 4, 2022 by Lacey Hvattum</p>
            <h4 className='blog-title'>Can Martial Arts Integrate Well into a Classical Education?</h4>
            <figure>
                <img src={Karate} alt='Child in martial arts pose on beach with sunset' className='blog-img col-md-8' />
            ...
            <div className='blog-content'>
                ...
                <p>
                    For more information on local martial arts classes, check out <a href='https://activemillcreek.com/' target='_blank'>http://activemartialartsmillcreek.com/</a>
                </p>
                <p>
