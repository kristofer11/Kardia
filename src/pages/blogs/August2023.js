import Sayers from '../../assets/blog/dorothy-sayers-232x300.jpg';
import LostToolsCover from '../../assets/blog/LostToolsCover.jpg'

const August2023 = () => {
    return (
        <div className='page-content blog'>
            <p className='blog-author'>AUGUST 29, 2023 by Kris Hvattum</p>
            <h4 className='blog-title'>Classical Roots: The Importance of "The Lost Tools of Learning" by Dorothy Sayers </h4>
            <figure>
                <img src={Sayers} alt='Portrait of Dorothy L Sayers, apologist and spiritual writer. She authored the essay The Lost Tools of Learning' />
            </figure>
