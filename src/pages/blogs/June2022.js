import Popsicles from '../../assets/blog/sharon-mccutcheon-df106IZ5Hck-unsplash-768x512.jpg';
    ...
    return (
        <div className='page-content blog'>
            ...
            <div className='blog-content'>
                ...
                <ol>
                    <li>Daily Reading</li>
{/* ADD PHOTOS TO THIS BLOG LATER IF LACEY WANTS THEM */}
                    {/* <figure className='blog-body-figure'> 
                        <img src={Popsicles} alt='Child in martial arts pose on beach' className='col-6 col-md-8 col-lg-6' />
                        <figcaption>Photo by Thao Le Hoang on Unsplash</figcaption>
                    </figure> */}
                    <p>
                    ...
                    <li>Daily Math Fact Practice</li>
                    ...
                    <p>This is a great option, especially if they are introspective or have an exciting break planned! It can be so fun for them to look back and remember how they felt when they went on the airplane…or that night you made a new s’mores combo while camping…or the first time they experienced the ocean. Get them a journal they like, and encourage them to personalize it. Younger kids can draw a picture with one sentence, whereas older kids can write a paragraph a day. You can even give them a writing prompt if they can’t think of anything!</p>
                ...
                <p>
                    For more information on local martial arts classes, check out <a href='http://activemartialartsmillcreek.com/' target='_blank'>http://activemartialartsmillcreek.com/</a>
                </p>
                <p>
                For more great information from Joanna Bischoff, visit her blog at <a src='https://homelifepurpose.com/' >https://homelifepurpose.com/</a>
                </p>
